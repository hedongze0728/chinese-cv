\resheading{待完成论文}
  \begin{itemize}[leftmargin=*]
   ...
   \item S.~J.~Jin, \textbf{D.~Z.~He}, Y.~D.~Xu, J.~F.~Zhang and X.~Zhang, ``Forecast for cosmological parameter estimation with gravitational-wave standard siren observation from the Cosmic Explorer", in preparation. 
